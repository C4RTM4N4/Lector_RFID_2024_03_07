...
namespace com.nem.aurawheel.Utils
{
    public class JSONSerializer
    {
                ...
                else if (c == '\\')
                {
                    ...
                    else if (c == 'u')
                    {
                        ...
                        if (remainingLength >= 4)
                        {
                            ...
                            try
                            {
                                codePoint = UInt32.Parse(new string(json, index, 4), NumberStyles.HexNumber, CultureInfo.InvariantCulture);
                                success = true;
                            }
                            catch (Exception)
                            {
        ...
        protected static double ParseNumber(char[] json, ref int index, ref bool success)
        {
            ...
            try
            {
                number = Double.Parse(new string(json, index, charLength), NumberStyles.Any, CultureInfo.InvariantCulture);
                success = true;
            }
            catch (Exception)
            {
        ...
        protected static bool SerializeValue(object value, StringBuilder builder)
        {
            ...
            {
                success = SerializeList((List<object>)value, builder);
            }
            else if (value is List<double>)
            {
                success = SerializeList((List<double>)value, builder);
            }
            else if (value is List<string>)
            {
                success = SerializeList((List<string>)value, builder);
            }
        ...
        protected static bool SerializeList(List<object> anList, StringBuilder builder)
        {
            builder.Append("[");
        ...
        protected static bool SerializeList(List<double> anList, StringBuilder builder)
        {
            builder.Append("[");
        ...
        protected static bool SerializeList(List<string> anList, StringBuilder builder)
        {
            builder.Append("[");
